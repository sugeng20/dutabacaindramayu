...
<body>
    ...
    <header class="header">
        ...
        <nav class="navbar navbar-expand-lg fixed-top custom-nav white-bg">
            <div class="container">
                <a class="navbar-brand" href="index-3.html"><img
                        src="{{ asset('frontend/img/logo-duta-baca-indramayu.png') }}" width="170" alt="logo"
                        class="img-fluid"></a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu submenu" aria-labelledby="navbarDropdownPage">
                                ...
                                <a class="dropdown-item" href="team.html">Team Page <span
                                        class="badge badge-danger badge-pill ml-2">New</span></a>
                                <a class="dropdown-item" href="team-single.html">Team Single <span
                                        class="badge badge-danger badge-pill ml-2">New</span></a>
                            </div>
                        </li>
                        <li class="nav-item dropdown">
                ...
                <div class="row align-items-center justify-content-between">
                    <div class="col-md-6 col-lg-6">
                        <div class="hero-content-left ptb-100">
                            <h1 style="font-size: 40px"><span>Paguyuban Duta Baca</span> Kabupaten Indramayu</h1>
                            <p class="lead">Menampilkan sosok inspiratif untuk menjadi motivator dalam membangkitkan
                                kegemaran membaca dan mengampanyekan
                                pembudayaan kegemaran membaca melalui berbagai media.</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7 col-md-8">
                        <div class="section-heading text-center mb-5">
                            <h2>DUTA BACA<br><span>KABUPATEN INDRAMAYU</span></h2>
                            <p class="lead">
                                Berikut Merupakan Perwakilan Duta Baca dari tiap diap daerah yang di Kabupaten Indramayu
                            </p>
                        </div>
                    </div>
                </div>
